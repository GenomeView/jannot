...
JAnnot</strong> is a Java library to handle biological sequence data. It is underlying GenomeView. It makes sure that files, websites, data bases, etc. can be used by GenomeView. Since the functionality of reading, writing and parsing data has more applications that just GenomeView, JAnnot is available as a separate package.
