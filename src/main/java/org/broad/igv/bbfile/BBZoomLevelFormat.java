...
public class BBZoomLevelFormat {
    ...
    private static Logger log = Logger.getLogger(BBZoomLevelFormat.class.getCanonicalName());
...
//            fis.readFully(buffer);
            ...
            log.log(Level.SEVERE,"Error reading zoom level data records (Table O) ", ex);
