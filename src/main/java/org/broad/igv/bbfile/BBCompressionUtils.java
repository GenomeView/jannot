...
public class BBCompressionUtils {
	 ...
	 * 
	 * Parameters: data - data buffer, where data.length indicates requested
	 * number of decompressed bytes. uncompressBufSize - recommended size for
	 * decompression chunks, or can be full byte size for the compressed region
	 * 
