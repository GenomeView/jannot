...
public class BBFileHeader {
    ...
    private static Logger log = Logger.getLogger(BBFileHeader.class.getCanonicalName());
...
//    private String path;               // bigBed file/pathname
    ...
    public BBFileHeader(SeekableStream fis, long fileOffset) {
...
//            fis.readFully(buffer);
            ...
            throw new RuntimeException("Error reading file header ", ex);
        }
