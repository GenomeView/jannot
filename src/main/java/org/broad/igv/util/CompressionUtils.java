...
/**
 * Created by IntelliJ IDEA. User: jrobinso, mdecautis Date: Dec 13, 2009 Time:
 * 4:16:42 PM To change this template use File | Settings | File Templates.
 */
public class CompressionUtils {

	private static Logger log = Logger
			.getLogger(CompressionUtils.class.getCanonicalName());
	 ...
	 * @param uncompressedChunkSize -- an estimate of the uncompressed chunk
	 *                              size. This need not be exact.
	 * @return
